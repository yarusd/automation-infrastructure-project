...
PUT_MOVIE_SCENARIOS = [
    # --- valid ---
    (VALID_MOVIE, 200, {"message": "Movie updated successfully"}, "1 - valid update"),
    ...
    pytest.param({**VALID_MOVIE, "title": "!@#$%^&*"}, 400, {"message": "title"}, "5 - invalid creds in title",
    ...
    pytest.param({**VALID_MOVIE, "year": 1900}, 400, {"message": "year"}, "12 - past year",
